...
fn embed_resource_file(target_dir: &Path) {
    ...
    let app_name = env::var("WARP_APP_NAME").unwrap_or("CastCodes".to_owned());
...
BEGIN
    ...
    BEGIN
        BLOCK "040904E4"
        BEGIN
            VALUE "CompanyName",      "CastCodes Maintainers\0"
            VALUE "FileDescription",  "{app_name}\0"
            VALUE "FileVersion",      "{version}\0"
            VALUE "LegalCopyright",   "© 2026, CastCodes Maintainers\0"
