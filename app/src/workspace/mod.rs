...
pub fn init(app: &mut AppContext) {
        ...
        #[cfg(debug_assertions)]
        {
            ...
            app.register_editable_bindings([
                ...
                EditableBinding::new(
                    ...
                    "[Debug] Install OpenCode CastCodes plugin",
                    WorkspaceAction::InstallOpenCodeWarpPlugin,
                )
                .with_context_predicate(id!("Workspace")),
                EditableBinding::new(
                    "workspace:use_local_opencode_warp_plugin",
                    "[Debug] Use local OpenCode CastCodes plugin (testing only)",
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Left Panel: Cast Drive"),
        ...
        EditableBinding::new(
            TOGGLE_WARP_DRIVE_BINDING_NAME,
            BindingDescription::new("Toggle Cast Drive")
    ...
    #[cfg(target_os = "macos")]
    {
        app.register_editable_bindings([
            ...
            EditableBinding::new(
                ...
                "Uninstall CastCodes CLI command",
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Open Settings: About")
                .with_custom_description(bindings::MAC_MENUS_CONTEXT, "About CastCodes"),
...
fn add_overflow_menu_items_as_editable_binding(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            "workspace:open_github_issues",
            "Open CastCodes GitHub issues (opens external link)",
            WorkspaceAction::OpenGitHubIssues,
        )
        .with_context_predicate(id!("Workspace")),
        EditableBinding::new(
