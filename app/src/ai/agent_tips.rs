...
static DEFAULT_TIPS: LazyLock<Vec<AgentTip>> = LazyLock::new(|| {
    vec![
        ...
        AgentTip {
            description: "<keybinding> to open the Command Palette and access CastCodes actions and shortcuts.".to_string(),
        ...
        AgentTip {
            description: "`@` to add context from files, blocks, or Cast Drive objects to your prompt.".to_string(),
...
impl WorkspaceAction {
    pub fn display_text(&self) -> Option<String> {
        match self {
            ...
            WorkspaceAction::OpenWarpDrive => Some("Cast Drive.".to_string()),
