...
const ZERO_STATE_HELP_TEXT: &str = "Shift + ctrl + space a block or text selection to ask the Cast Agent.";
...
pub fn init(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        EditableBinding::new(
            ...
            "Focus Terminal Input From Cast Agent",
